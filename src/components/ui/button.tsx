  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-medium transform hover:scale-105 transition-bounce",
        cart: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft",
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-strong transform hover:scale-105 transition-bounce text-base font-semibold",
      },
      size: {
